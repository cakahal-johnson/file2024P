         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-8 col-xl-6">
                  ...
                  <p>
                     We strictly follow the State Board’s sanitary and disinfection
                     guidelines.
                  </p>
            ...
            <div class="row">
               <div class="col-lg-12">
                  ...
                  <img src="img/food/Logo Healthy Lifestylers.png" alt="#" style="width: 100px"/>
                  <p class="footer-text">
                     ...
                     All rights reserved | Health is Wealth
                     <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                  </p>
                  </div>
               </div>
